...
import { CuteIcon, CuteProgress } from "../../components";
...
const music = (
  <p style={{ textAlign: "center" }}>
    ...
    <br />
    His code not &ldquo;functional&rdquo; or &ldquo;elegant&rdquo;
    <br />
    ...
    Take bath, take nap
    <br />
    This job &ldquo;fulfilling in creative way&rdquo;
    <br />
    Such a load of crap
    <br />
            ...
            <div className="about-content-box">
              ...
              <div className="about_skill_area">
                {skills.map((skill, index) => {
                  return (
                    <CuteProgress key={"lp-" + index} percent={skill.percent}>
                      <h4
                        style={{
                          width: "4rem",
                          margin: "auto",
